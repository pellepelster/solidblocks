...
class YamlTest {
    ...
    fun `parse`() {
        ...
        yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
    }
    ...
    fun `parse error`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlError<YamlNode>>()
    ...
    fun `get list`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val list = result.data.getList("key1").shouldBeTypeOf<YamlSuccess<YamlList>>()
    ...
    fun `get list error`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val list = result.data.getList("key1").shouldBeTypeOf<YamlError<YamlNode>>()
    ...
    fun `get string`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val string = result.data.getString("key1").shouldBeTypeOf<YamlSuccess<String?>>()
    ...
    fun `get string empty`() {
        ...
        val nonNullOrEmptyString =
            result.data.getNonNullOrEmptyString("key1").shouldBeTypeOf<YamlError<String>>()
    ...
    fun `get boolean`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val bool = result.data.getBoolean("key1").shouldBeTypeOf<YamlSuccess<Boolean>>()
        bool.data shouldBe false

        val optionalBool = result.data.getOptionalBoolean("key1").shouldBeTypeOf<YamlSuccess<Boolean?>>()
    ...
    fun `get boolean empty`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val bool = result.data.getBoolean("key1").shouldBeTypeOf<YamlError<Boolean>>()
    ...
    fun `get boolean invalid`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val string = result.data.getBoolean("key1").shouldBeTypeOf<YamlError<Boolean?>>()
    ...
    fun `get boolean no value`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val string = result.data.getBoolean("key1").shouldBeTypeOf<YamlError<String?>>()
        string.error shouldBe "key 'key1' is null at line 1 column 1"
    }
    ...
    fun `get map`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val map = result.data.getMap("key1").shouldBeTypeOf<YamlSuccess<YamlMap>>()
    ...
    fun `get string map`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val map = result.data.getStringMap("key1").shouldBeTypeOf<YamlSuccess<Map<String, String>>>()
        map.data.entries.count() shouldBe 1
    ...
    fun `get string map non string`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val map = result.data.getStringMap("key1").shouldBeTypeOf<YamlError<Map<String, String>>>()
    ...
    fun `get map list error`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val map = result.data.getMap("key1").shouldBeTypeOf<YamlError<YamlMap>>()
    ...
    fun `get map empty1`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        result.data.getMap("key1").shouldBeTypeOf<YamlSuccess<YamlMap>>()
    }
    ...
    fun `get number null`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val number = result.data.getNumber("key1").shouldBeTypeOf<YamlError<Number?>>()
    ...
    fun `get number`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val number = result.data.getNumber("key1").shouldBeTypeOf<YamlSuccess<Number?>>()
    ...
    class ItemFactory : ConfigurationFactory<Item> {
        ...
        override fun parse(yaml: YamlNode): Result<Item> = when (val name = yaml.getNonNullOrEmptyString("name")) {
            is YamlEmpty<String> -> Error(name.message)
            is YamlError<String> -> Error(name.error)
            is YamlSuccess<String> -> Success(Item(name.data))
        }
    }
    ...
    fun `get polymorphic list`() {
        ...
        list.shouldBeTypeOf<YamlSuccess<List<BaseType>>>()
    ...
    fun `get polymorphic list type missing`() {
        ...
        val list =
            result.data
                ...
                .shouldBeTypeOf<YamlError<YamlNode>>()
    ...
    fun `get number with default returns value when key present`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val number = result.data.getNumber("key1", 5).shouldBeTypeOf<YamlSuccess<Number>>()
    ...
    fun `get number with default returns error for invalid value`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val number = result.data.getNumber("key1", 5).shouldBeTypeOf<YamlError<Number>>()
        number.error shouldBe "expected number but got 'abc' at line 1 column 1"
    }
    ...
    fun `get optional number returns value`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val number = result.data.getOptionalNumber("key1").shouldBeTypeOf<YamlSuccess<Int?>>()
        number.data shouldBe 123
    }
    ...
    fun `get optional number returns error for invalid value`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val number = result.data.getOptionalNumber("key1").shouldBeTypeOf<YamlError<Int?>>()
        number.error shouldBe "expected number but got 'abc' at line 1 column 1"
    }
    ...
    fun `get optional string returns value`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val string = result.data.getOptionalString("key1").shouldBeTypeOf<YamlSuccess<String?>>()
    ...
    fun `get optional string with default returns value when key present`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val string = result.data.getOptionalString("key1", "default1").shouldBeTypeOf<YamlSuccess<String>>()
        string.data shouldBe "foo"
    }
    ...
    fun `get optional boolean returns null when key missing`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val bool = result.data.getOptionalBoolean("key1").shouldBeTypeOf<YamlSuccess<Boolean?>>()
    ...
    fun `get optional boolean returns error for invalid value`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val bool = result.data.getOptionalBoolean("key1").shouldBeTypeOf<YamlError<Boolean?>>()
    ...
    fun `get boolean with default returns value when key present`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val bool = result.data.getBoolean("key1", true).shouldBeTypeOf<YamlSuccess<Boolean>>()
        bool.data shouldBe false
    }
    ...
    fun `get boolean with default returns error for invalid value`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val bool = result.data.getBoolean("key1", true).shouldBeTypeOf<YamlError<Boolean>>()
        bool.error shouldBe "expected 'true' or 'false' but got 'yolo' at line 1 column 1"
    }
    ...
    fun `get string on scalar document returns error`() {
        val result = yamlParse("foo").shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val string = result.data.getString("key1").shouldBeTypeOf<YamlError<String>>()
    ...
    fun `get list on scalar document returns error`() {
        val result = yamlParse("foo").shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val list = result.data.getList("key1").shouldBeTypeOf<YamlError<YamlList>>()
    ...
    fun `get keys on scalar document returns error`() {
        val result = yamlParse("foo").shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val keys = result.data.getKeys().shouldBeTypeOf<YamlError<List<String>>>()
    ...
    fun `get keys returns all keys`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val keys = result.data.getKeys().shouldBeTypeOf<YamlSuccess<List<String>>>()
    ...
    fun `get non null or empty string returns error when key missing`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val string = result.data.getNonNullOrEmptyString("key1").shouldBeTypeOf<YamlError<String>>()
        string.error shouldBe "key 'key1' not found at line 1 column 1"
    }
    ...
    fun `get list with factory parses all items`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val list = result.data.getList("key1", ItemFactory()).shouldBeTypeOf<YamlSuccess<List<Item>>>()
    ...
    fun `get list with factory aggregates item errors`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val list = result.data.getList("key1", ItemFactory()).shouldBeTypeOf<YamlError<List<Item>>>()
        list.error shouldBe
    ...
    fun `get object parses map`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val obj = result.data.getObject("key1", ItemFactory()).shouldBeTypeOf<YamlSuccess<Item>>()
    ...
    fun `get object parses empty map when key missing`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val obj = result.data.getObject("key1", EntryCountFactory()).shouldBeTypeOf<YamlSuccess<Int>>()
        obj.data shouldBe 0
    }
    ...
    fun `get object returns error when key is a list`() {
        ...
        val result = yamlParse(rawYaml).shouldBeTypeOf<YamlSuccess<YamlNode>>()
        val obj = result.data.getObject("key1", ItemFactory()).shouldBeTypeOf<YamlError<Item>>()
    ...
    fun `get polymorphic list returns empty list when key missing`() {
        ...
        val list =
            result.data
                ...
                .shouldBeTypeOf<YamlSuccess<List<BaseType>>>()
    ...
    fun `get polymorphic list returns error when key is not a list`() {
        ...
        val list =
            result.data
                ...
                .shouldBeTypeOf<YamlError<List<BaseType>>>()
