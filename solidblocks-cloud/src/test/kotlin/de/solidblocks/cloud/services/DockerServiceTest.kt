...
class DockerServiceTest {
    ...
    fun testParse() {
        ...
        val cloud = ConfigurationParser(CloudConfigurationFactory(emptyList(), listOf(DockerServiceRegistration()))).parse(rawYml).shouldBeTypeOf<Success<CloudConfiguration>>()
    ...
    fun testValidate() {
        ...
        val cloud = CloudConfiguration("cloud1", "cloud1.test-blcks.de", emptyList(), listOf(DockerServiceConfiguration("docker2", emptyList(), listOf("docker1"))))
        val configuration = DockerServiceConfiguration("docker1", emptyList(), listOf("docker2"))

        val result = DockerServiceManager().validatConfiguration(2, cloud, configuration, TEST_PROVISIONER_CONTEXT, TEST_LOG_CONTEXT).shouldBeInstanceOf<Success<DockerServiceConfigurationRuntime>>().data
    ...
    fun testInvalidLink() {
        ...
        val result = DockerServiceManager().validatConfiguration(2, cloud, configuration, TEST_PROVISIONER_CONTEXT, TEST_LOG_CONTEXT).shouldBeInstanceOf<Error<DockerServiceConfigurationRuntime>>()
    ...
    fun testSelfLink() {
        ...
        val cloud = CloudConfiguration("cloud1", "cloud1.test-blcks.de", emptyList(), listOf(configuration))
    ...
    fun testDuplicatedPortConfig() {
        val cloud = CloudConfiguration("cloud1", "cloud1.test-blcks.de", emptyList(), emptyList())
        val configuration = DockerServiceConfiguration("docker1", listOf(
