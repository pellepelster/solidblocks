...
class HetznerNetworkProvisionerTest {
    ...
    fun testFlow(context: SolidblocksTestContext) {
        ...
        runBlocking {
            ...
            // create new label
            val resourceWithNewLabel = HetznerNetwork(name, "10.0.0.0/8", hetzner.defaultLabels + mapOf("foo" to "bar"))
            ...
            val resourceWithNewDeleteProtection = HetznerNetwork(name, "10.0.0.0/8", protected = false, labels = hetzner.defaultLabels)
