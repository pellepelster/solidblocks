...
class GarageFsAccessKeyProvisioner :
    ...
    override suspend fun lookup(lookup: GarageFsAccessKeyLookup, context: ProvisionerLookupContext) = when (val result = lookupInternal(lookup, context as SSHProvisionerContext)) {
