...
class HetznerNetworkRuntime(val id: Long, val name: String, val ipRange: String, val deleteProtected: Boolean, labels: Map<String, String>, val subnets: List<HetznerSubnetRuntime>) :
