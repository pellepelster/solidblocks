...
class CloudProvisioner(
    ...
    private fun createResourceGroups(): List<ResourceGroup> {
        ...
        val cloudResourceGroup = ResourceGroup("cloud '${runtime.name} base resources'", listOf(sshKey, network, subnet))
    ...
    private fun serviceManagers() = runtime.services.map {
        val manager:
                ServiceManager<ServiceConfiguration, ServiceConfigurationRuntime> =
