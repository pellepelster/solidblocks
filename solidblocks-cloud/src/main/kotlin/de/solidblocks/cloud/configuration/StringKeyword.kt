...
abstract class BaseStringKeyword<T>(
...
class StringKeyword(name: String, constraints: StringConstraints, help: KeywordHelp) :
    BaseStringKeyword<String>(name, constraints, false, null, help) {
...
class StringKeywordOptional(name: String, constraints: StringConstraints, help: KeywordHelp) :
    BaseStringKeyword<String?>(name, constraints, true, null, help) {
...
class StringKeywordOptionalWithDefault(
    name: String,
    constraints: StringConstraints,
    default: String,
    help: KeywordHelp,
) : BaseStringKeyword<String>(name, constraints, true, default, help) {
