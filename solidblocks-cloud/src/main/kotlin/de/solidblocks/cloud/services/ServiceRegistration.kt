...
fun <C : ServiceConfiguration, R : ServiceConfigurationRuntime> List<ServiceRegistration<*, *>>.managerForService(
    configuration: C, cloudConfiguration: CloudConfiguration
...
fun <C : ServiceConfiguration, R : ServiceConfigurationRuntime> List<ServiceRegistration<*, *>>.managerForService(
    runtime: R, cloudConfiguration: CloudConfiguration,
): ServiceConfigurationManager<C, R> =
