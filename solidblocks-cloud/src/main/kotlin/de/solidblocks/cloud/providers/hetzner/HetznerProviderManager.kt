...
class HetznerProviderManager :
    CloudResourceProviderManager<HetznerProviderConfiguration, HetznerProviderRuntime> {

    private val logger = KotlinLogging.logger {}

    override fun validateConfiguration(configuration: HetznerProviderConfiguration, context: CloudConfigurationContext, log: LogContext): Result<HetznerProviderRuntime> {
        val hcloudToken = getPropertyOrEnv("HCLOUD_TOKEN")
    ...
    override fun createProvisioners(runtime: HetznerProviderRuntime) = listOf(
        ...
        HetznerFloatingIpProvisioner(runtime.cloudToken),
