...
class HetznerProviderConfiguration(
    override val name: String,
    val defaultLocation: HetznerLocation,
    val defaultInstanceType: HetznerServerType,
) : CloudResourceProviderConfiguration {
  override val type = HETZNER_PROVIDER_TYPE
}

// TODO clean up when multi provider support is needed
fun List<ProviderConfiguration>.hetznerProviderConfig() =
    this.filterIsInstance<HetznerProviderConfiguration>().single()
