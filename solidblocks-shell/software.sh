...
# see https://pellepelster.github.io/solidblocks/shell/software/#software_ensure_shellcheckversion-checksum
...
# see https://pellepelster.github.io/solidblocks/shell/software/#software_hashicorp_ensureproduct-version-checksum
