...
class PgBackRestTest {
    ...
    fun testParseInfoOutput() {
        ...
        assertSoftly(output.parsePgBackRestInfoOutput()) {
            ...
            it[0].backup[0].timestamp.start shouldBe java.time.Instant.parse("2026-04-09T12:49:22Z")
            it[0].backup[0].timestamp.stop shouldBe java.time.Instant.parse("2026-04-09T12:49:46Z")
