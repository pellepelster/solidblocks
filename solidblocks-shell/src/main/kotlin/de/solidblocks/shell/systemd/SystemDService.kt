package de.solidblocks.shell.systemd
...
class SystemDTimer(override val name: String, val unit: Unit, val timer: Timer, val install: Install) : SystemDConfig {
...
class SystemDService(override val name: String, val unit: Unit, val service: Service, val install: Install? = null) : SystemDConfig {
    override fun render(): String {
        val sw = StringWriter()
