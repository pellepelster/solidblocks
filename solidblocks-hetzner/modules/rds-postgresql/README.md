...
| <a name="input_backup_s3_host"></a> [backup\_s3\_host](#input\_backup\_s3\_host_) | AWS host for S3 backups. | `string` | `s3.eu-central-1.amazonaws.com` | no |
| <a name="input_backup_s3_retention_full_type"></a> [backup\_s3\_retention\_full\_type](#input\_backup\_s3\_retention\_full\_type) | AWS S3 backups retention policy type [count, time]. | `string` | `count` | no |
| <a name="input_backup_s3_retention_full"></a> [backup\_s3\_retention\_full](#input\_backup\_s3\_retention\_full) | AWS S3 backups full backup retention count/time. | `number` | `7` | no |
| <a name="input_backup_s3_retention_diff"></a> [backup\_s3\_retention\_diff](#input\_backup\_s3\_retention\_diff) | AWS S3 backup number of differential backups to retain. | `number` | `4` | no |
...
| <a name="input_solidblocks_cloud_init_version"></a> [solidblocks\_cloud\_init\_version](#input\_solidblocks\_cloud\_init\_version) | used for integration tests to inject test versions | `string` | `"v0.2.0"` | no |
| <a name="input_solidblocks_rds_version"></a> [solidblocks\_rds\_version](#input\_solidblocks\_rds\_version) | used for integration tests to inject test versions | `string` | `"v0.2.0"` | no |
