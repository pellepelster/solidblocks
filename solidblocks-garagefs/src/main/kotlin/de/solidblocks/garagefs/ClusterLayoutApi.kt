...
@Serializable
data class ClusterLayoutNodeResponse(val capacity: Long, val id: String, val zone: String, val tags: List<String>)

@Serializable
data class ClusterLayoutNodeRequest(val id: String, val capacity: Long, val tags: List<String> = emptyList(), val zone: String)
