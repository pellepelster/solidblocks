...
class VaultProvisionerTest {
    ...
    fun testPkiBackendRoleDiffAndApply(testEnvironment: TestEnvironment) {
        ...
        assertTrue(updateDiff.result?.needsApply()!!)
    }
