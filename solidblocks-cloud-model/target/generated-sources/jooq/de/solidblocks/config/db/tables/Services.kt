...
open class Services(
    ...
    /**
     * The column <code>SERVICES.ENVIRONMENT</code>.
     */
    val ENVIRONMENT: TableField<ServicesRecord, UUID?> = createField(DSL.name("ENVIRONMENT"), SQLDataType.UUID.nullable(false), this, "")
