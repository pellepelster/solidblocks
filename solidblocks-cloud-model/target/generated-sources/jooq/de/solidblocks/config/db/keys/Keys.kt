...
val FK_SERVICES_CLOUD_ID: ForeignKey<ServicesRecord, EnvironmentsRecord> = Internal.createForeignKey(Services.SERVICES, DSL.name("FK_SERVICES_CLOUD_ID"), arrayOf(Services.SERVICES.ENVIRONMENT), de.solidblocks.config.db.keys.PK_ENVIRONMENTS, arrayOf(Environments.ENVIRONMENTS.ID), true)
