...
open class ScheduledTasks(
     ...
     */
    val EXECUTION_TIME: TableField<ScheduledTasksRecord, OffsetDateTime?> = createField(DSL.name("EXECUTION_TIME"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "")
     ...
     */
    val LAST_SUCCESS: TableField<ScheduledTasksRecord, OffsetDateTime?> = createField(DSL.name("LAST_SUCCESS"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "")

    /**
     * The column <code>SCHEDULED_TASKS.LAST_FAILURE</code>.
     */
    val LAST_FAILURE: TableField<ScheduledTasksRecord, OffsetDateTime?> = createField(DSL.name("LAST_FAILURE"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "")
     ...
     */
    val LAST_HEARTBEAT: TableField<ScheduledTasksRecord, OffsetDateTime?> = createField(DSL.name("LAST_HEARTBEAT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "")
