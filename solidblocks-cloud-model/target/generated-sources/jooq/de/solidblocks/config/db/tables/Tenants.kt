...
import de.solidblocks.config.db.indexes.IDX_TENANTS_ENVIRONMENT_NAME
import de.solidblocks.config.db.keys.FK_TENANTS_ENVIRONMENT_ID
...
open class Tenants(
    ...
    override fun getIndexes(): List<Index> = listOf(IDX_TENANTS_ENVIRONMENT_NAME)
    ...
    override fun getReferences(): List<ForeignKey<TenantsRecord, *>> = listOf(FK_TENANTS_ENVIRONMENT_ID)

    private lateinit var _environments: Environments
    fun environments(): Environments {
        if (!this::_environments.isInitialized)
            _environments = Environments(this, FK_TENANTS_ENVIRONMENT_ID)
