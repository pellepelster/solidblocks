...
class RdsPostgresqlAwsS3BackupIntegrationTest {
    ...
    fun testDatabaseKeepsDataBetweenRestarts(version: Int, rdsTestBed: RdsTestBed, testContext: SolidblocksTestContext) {
        ...
        val container =
            rdsTestBed.createAndStartPostgresContainer(
                version,
                s3BackupEnv + mapOf("DB_BACKUP_S3_BUCKET" to bucket),
                dataDir,
            )
    ...
    @Test
    fun testRestoreDatabaseFromFullBackup(rdsTestBed: RdsTestBed, testContext: SolidblocksTestContext) {
        val bucket = testContext.aws().createBucket()
    ...
    @Test
    fun testRestoreOnlyFromFullBackup(rdsTestBed: RdsTestBed, testContext: SolidblocksTestContext) {
        val bucket = testContext.aws().createBucket()
        val postgresContainer1 =
            rdsTestBed.createAndStartPostgresContainer(
                14,
    ...
    @Test
    fun testRestoreDatabaseFromIncrementalBackup(rdsTestBed: RdsTestBed, testContext: SolidblocksTestContext) {
        val bucket = testContext.aws().createBucket()
        val postgresContainer1 =
            rdsTestBed.createAndStartPostgresContainer(
                14,
    ...
    @Test
    fun testRestoreDatabaseFromDifferentialBackup(rdsTestBed: RdsTestBed, testContext: SolidblocksTestContext) {
        val bucket = testContext.aws().createBucket()
        val postgresContainer1 =
            rdsTestBed.createAndStartPostgresContainer(
                14,
