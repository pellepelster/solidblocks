...
class RdsPostgresqlAwsS3BackupIntegrationTest {
  ...
  fun testDatabaseKeepsDataBetweenRestarts(
      ...
      testContext: SolidblocksTestContext,
  ) {
  ...
  @Test
  fun testRestoreDatabaseFromFullBackup(
      rdsTestBed: RdsTestBed,
      testContext: SolidblocksTestContext,
  ) {
    val bucket = testContext.aws().createBucket()
  ...
  @Test
  fun testRestoreDatabaseFromIncrementalBackup(
      rdsTestBed: RdsTestBed,
      testContext: SolidblocksTestContext,
  ) {
    val bucket = testContext.aws().createBucket()
  ...
  @Test
  fun testRestoreDatabaseFromDifferentialBackup(
      rdsTestBed: RdsTestBed,
      testContext: SolidblocksTestContext,
  ) {
    val bucket = testContext.aws().createBucket()
