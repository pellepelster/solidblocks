...
class HetznerTestBedExtension :
    ...
    override fun supportsParameter(parameterContext: ParameterContext, extensionContext: ExtensionContext): Boolean = parameterContext.parameter.type == HetznerTestBed::class.java
