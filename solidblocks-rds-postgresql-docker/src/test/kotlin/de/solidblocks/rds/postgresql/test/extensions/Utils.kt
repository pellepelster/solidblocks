...
fun GenericContainer<out GenericContainer<*>>.createJdbi(username: String = TestConstants.DATABASE_USER, password: String = TestConstants.DATABASE_PASSWORD, database: String = TestConstants.DATABASE): Jdbi {
...
fun Jdbi.selectAllUsers(): List<Map<String, Any>>? = this.withHandle<List<Map<String, Any>>, RuntimeException> {
