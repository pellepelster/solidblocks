...
class RdsTestBedExtension :
    ...
    override fun supportsParameter(parameterContext: ParameterContext, extensionContext: ExtensionContext): Boolean = parameterContext.parameter.type == RdsTestBed::class.java

    @Throws(ParameterResolutionException::class)
    override fun resolveParameter(parameterContext: ParameterContext, extensionContext: ExtensionContext): Any {
        logger.info { "[test] creating RDS testbed" }
        return testBeds.getOrPut(extensionContext.uniqueId) { RdsTestBed() }
    }
