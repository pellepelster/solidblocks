...
@Serializable
data class PrimaryIpListWrapper(@SerialName("primary_ips") val primaryIps: List<PrimaryIpResponse>, override val meta: MetaResponse) : ListResponse<PrimaryIpResponse> {
...
class HetznerPrimaryIpsApi(private val api: HetznerApi) :
    ...
    override suspend fun listPaged(page: Int, perPage: Int, filter: Map<String, FilterValue>, labelSelectors: Map<String, LabelSelectorValue>): PrimaryIpListWrapper =
