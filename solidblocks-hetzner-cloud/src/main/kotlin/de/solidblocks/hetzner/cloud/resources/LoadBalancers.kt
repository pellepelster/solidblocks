...
@Serializable
data class LoadBalancerAttachRequest(val type: LoadBalancerTargetType, val server: LoadBalancerAttachServerRequest)
...
class HetznerLoadBalancersApi(private val api: HetznerApi) :
    ...
    override suspend fun listPaged(page: Int, perPage: Int, filter: Map<String, FilterValue>, labelSelectors: Map<String, LabelSelectorValue>): LoadBalancersListWrapper =
