...
object VolumeFormatNullSerializer : KSerializer<VolumeFormat?> {

  override val descriptor: SerialDescriptor =
      PrimitiveSerialDescriptor("VolumeFormatNull", PrimitiveKind.STRING)

  override fun serialize(encoder: Encoder, value: VolumeFormat?) {}

  override fun deserialize(decoder: Decoder): VolumeFormat? = null
}
