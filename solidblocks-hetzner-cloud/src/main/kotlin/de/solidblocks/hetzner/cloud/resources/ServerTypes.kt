...
class HetznerServerTypesApi(private val api: HetznerApi) : HetznerBaseResourceApi<ServerTypeResponse> {
    override suspend fun listPaged(page: Int, perPage: Int, filter: Map<String, FilterValue>, labelSelectors: Map<String, LabelSelectorValue>): ServerTypeListResponseWrapper =
