...
@Serializable
data class SSHKeysCreateRequest(val name: String, @SerialName("public_key") val publicKey: String, val labels: Map<String, String> = emptyMap())
...
class HetznerSSHKeysApi(private val api: HetznerApi) : HetznerDeleteResourceApi<Long, SshKeyResponse> {
    override suspend fun listPaged(page: Int, perPage: Int, filter: Map<String, FilterValue>, labelSelectors: Map<String, LabelSelectorValue>): SSHKeysListResponseWrapper =
