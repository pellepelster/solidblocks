...
interface HetznerBaseResourceApi<T> {
    suspend fun listPaged(page: Int = 0, perPage: Int = 25, filter: Map<String, FilterValue> = emptyMap(), labelSelectors: Map<String, LabelSelectorValue> = emptyMap()): ListResponse<T>

    suspend fun list(filter: Map<String, FilterValue> = emptyMap(), labelSelectors: Map<String, LabelSelectorValue> = emptyMap()) =
