...
@Serializable data class HetznerApiErrorWrapper(val error: HetznerApiError)
...
@Serializable data class HetznerApiErrorDetailsField(val name: String, val messages: List<String>)
