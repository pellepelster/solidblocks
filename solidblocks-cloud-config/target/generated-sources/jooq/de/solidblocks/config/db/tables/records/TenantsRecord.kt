...
open class TenantsRecord() : UpdatableRecordImpl<TenantsRecord>(Tenants.TENANTS), Record4<UUID?, String?, Boolean?, UUID?> {
    ...
    override fun values(value1: UUID?, value2: String?, value3: Boolean?, value4: UUID?): TenantsRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
