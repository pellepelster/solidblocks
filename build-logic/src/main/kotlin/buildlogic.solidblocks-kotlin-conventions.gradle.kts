...
tasks.test {
    ...
    environment(
        mapOf(
            ...
            "GITHUB_TOKEN" to providers.of(PassSecretValueSource::class) {
                this.parameters.path.set("solidblocks/github/test/pat")
                this.parameters.environment.set("GITHUB_TOKEN")
            }.get(),
