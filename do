...
TEMP_DIR="${DIR}/.temp"
COMPONENTS="solidblocks-cli solidblocks-test solidblocks-ansible solidblocks-k3s solidblocks-shell solidblocks-cloud-init solidblocks-rds-postgresql-hetzner solidblocks-debug-container solidblocks-sshd solidblocks-rds-postgresql-docker solidblocks-rds-postgresql-ansible solidblocks-do-python solidblocks-web-s3-docker-hetzner"
