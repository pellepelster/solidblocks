...
class ResourcePermissionTest {
    ...
    fun testMultiplePermissions() {
        ...
        assertThat(listOf("srn:cloud1::", "srn:cloud2:env2:tenant1").parsePermissions().isEnvironmentWildcard).isTrue
        assertThat(listOf("srn:cloud1:env1:tenant1", "srn:cloud2:env2:tenant2").parsePermissions().isEnvironmentWildcard).isFalse
