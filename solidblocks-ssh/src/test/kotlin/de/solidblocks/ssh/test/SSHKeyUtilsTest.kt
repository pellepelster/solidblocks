...
class SSHKeyUtilsTest {
    ...
    fun testPublicKeyToOpenSSHEd25519() {
        ...
        SSHKeyUtils.publicKeyToOpenSSH(key.public) shouldBe "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFcHCF1q7A+sGGv+o6YvcE7j7RAf6LHuoiaJTD2+PONv"
    }

    @Test
    fun testPublicKeyToOpenSSHRSA() {
        val key = loadKey(privateKeyOpensshRsa)
        SSHKeyUtils.publicKeyToOpenSSH(key.public) shouldBe "ssh-rsa "
    }
