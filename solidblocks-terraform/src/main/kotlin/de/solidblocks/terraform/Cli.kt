...
class S3Command : CliktCommand(help = "create AWS S3 backend") {
    val awsSecretAccessKey by option("--aws-secret-access-key", envvar = "AWS_SECRET_ACCESS_KEY").required()
...
fun main(args: Array<String>) = CliCommand().subcommands(BackendCommand().subcommands(S3Command())).main(args)