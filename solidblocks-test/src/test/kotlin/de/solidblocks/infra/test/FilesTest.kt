...
public class FilesTest {
  ...
  fun testFilesMatcher() {
    ...
    tempDir.matchSingleFile(".*somefile.txt.*") shouldHaveChecksum
        "78d656f38710e2366b6aac471ba207d38efa3720ae383b8b31f0384db6bbd8c4"
    tempDir.matchSingleFile(".*anotherfile.txt.*") shouldHaveChecksum
        "d922d8fba18c13a1f24d53aa6e37e37d6c4e15d9d1661a9b9dca6697fd65c0dd"

    tempDir.singleFile("anotherfile.txt") shouldHaveChecksum
        "d922d8fba18c13a1f24d53aa6e37e37d6c4e15d9d1661a9b9dca6697fd65c0dd"

    val exception = shouldThrow<RuntimeException> { tempDir.matchSingleFile(".*file.*") }
    exception.message should
        startWith("expected regex '.*file.*' to match exactly one file, but it matched")
  }
  ...
  fun testFileFromPath() {
    ...
    tempDir shouldContainNFiles 0
    tempDir
        .fileFromPath(Path(this.javaClass.classLoader.getResource("command-failure.sh")!!.path))
        .create()
  ...
  fun testZipFile() {
    ...
    tempDir
        ...
        .entry("file2.txt", "some more content")
        .create()
