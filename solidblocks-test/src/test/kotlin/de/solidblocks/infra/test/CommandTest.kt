...
public class CommandTest {
    ...
    fun testFailure(context: TestContext) {
        assertSoftly(context.command(getCommandPath("command-failure.sh")).run()) {
    ...
    fun testSuccess(context: TestContext) {
        assertSoftly(context.command(getCommandPath("command-success.sh")).run()) {
    ...
    fun testStdout(context: TestContext) {
        assertSoftly(context.command(getCommandPath("command-stdout.sh")).run()) {
            it shouldHaveExitCode 0
    ...
    fun testStderr(context: TestContext) {
        assertSoftly(context.command(getCommandPath("command-stderr.sh")).run()) {
            it shouldHaveExitCode 0
            it stdoutShouldBe ""
