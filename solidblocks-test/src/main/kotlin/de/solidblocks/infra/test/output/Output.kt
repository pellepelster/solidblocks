...
class TimestampedOutputLine(val timestamp: TimeSource.Monotonic.ValueTimeMark, line: String, type: OutputType) : OutputLine(line, type)
...
suspend fun waitForOutputMatcher(context: LogContext, outputMatcher: OutputMatcher, output: List<TimestampedOutputLine>, stdin: SendChannel<String>) {
    logInfo(
