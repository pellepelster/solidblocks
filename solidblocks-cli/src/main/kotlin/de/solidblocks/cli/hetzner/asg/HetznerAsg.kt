...
class HetznerAsg(hcloudToken: String) {
    ...
    fun rotate(
        ...
        logInfo("starting rollout with id '${deploymentId}' to ${replicas} replicas, server name prefix is '${serverNamePrefix}' and timeout for newly created servers is '${healthTimeout}'")
