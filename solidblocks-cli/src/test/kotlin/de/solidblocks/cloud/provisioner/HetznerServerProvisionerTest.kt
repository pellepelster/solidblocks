        ...
        runBlocking {
            ...
            val registry =
                ProvisionersRegistry(
                    listOf(UserDataLookupProvider(), sshProvisioner, volumeProvisioner, serverProvisioner),
            ...
            provisioner.apply(listOf(sshKey1, sshKey2, volume), context, TEST_LOG_CONTEXT).shouldBeTypeOf<Success<Unit>>()
