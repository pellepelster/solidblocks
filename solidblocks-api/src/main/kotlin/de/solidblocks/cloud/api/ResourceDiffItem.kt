...
data class ResourceDiffItem(val name: String, val changed: Boolean = false, val triggersRecreate: Boolean = false, val missing: Boolean = false, val expectedValue: Any? = null, val actualValue: Any? = null) {
