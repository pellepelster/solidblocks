...
```kotlin
{{% include "snippets/solidblocks-test-example/src/test/kotlin/de/solidblocks/test/ssh/SSH.kt" %}}
```
...
```kotlin
{{% include "snippets/solidblocks-test-example/src/test/kotlin/de/solidblocks/test/ssh/SSHAssertions.kt" %}}
```
