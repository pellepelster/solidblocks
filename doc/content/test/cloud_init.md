...
```kotlin
{{% include-safe "snippets/solidblocks-test-example/src/test/kotlin/de/solidblocks/test/cloudinit/CloudInitContext.kt" %}}
```
...
```kotlin
{{% include-safe "snippets/solidblocks-test-example/src/test/kotlin/de/solidblocks/test/cloudinit/CloudInitAssertions.kt" %}}
```
