...
```terraform
{{% include-safe "/snippets/hetzner-postgres-rds-s3-backup/instance/main.tf" %}}
```
...
```terraform
{{% include-safe "/snippets/hetzner-postgres-rds-local-backup/instance/main.tf" %}}
```
...
```terraform
{{% include-safe "/snippets/hetzner-postgres-rds-private-network/instance/main.tf" %}}
```
...
```terraform
{{% include-safe "/snippets/hetzner-postgres-rds-hetzner-s3-backup/instance/main.tf" %}}
```
