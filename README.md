...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.34/solidblocks-shell-v0.0.34.zip > solidblocks-shell-v0.0.34.zip
unzip solidblocks-shell-v0.0.34.zip
```
