...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.36/solidblocks-shell-v0.0.36.zip > solidblocks-shell-v0.0.36.zip
unzip solidblocks-shell-v0.0.36.zip
```
