...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.39/solidblocks-shell-v0.0.39.zip > solidblocks-shell-v0.0.39.zip
unzip solidblocks-shell-v0.0.39.zip
```
