...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.23/solidblocks-shell-v0.0.23.zip > solidblocks-shell-v0.0.23.zip
unzip solidblocks-shell-v0.0.23.zip
```
