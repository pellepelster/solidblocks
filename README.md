...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.28/solidblocks-shell-v0.0.28.zip > solidblocks-shell-v0.0.28.zip
unzip solidblocks-shell-v0.0.28.zip
```
