...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.26/solidblocks-shell-v0.0.26.zip > solidblocks-shell-v0.0.26.zip
unzip solidblocks-shell-v0.0.26.zip
```
