...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.58/solidblocks-shell-v0.0.58.zip > solidblocks-shell-v0.0.58.zip
unzip solidblocks-shell-v0.0.58.zip
```
