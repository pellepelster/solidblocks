...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.29/solidblocks-shell-v0.0.29.zip > solidblocks-shell-v0.0.29.zip
unzip solidblocks-shell-v0.0.29.zip
```
