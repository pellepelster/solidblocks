...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.43/solidblocks-shell-v0.0.43.zip > solidblocks-shell-v0.0.43.zip
unzip solidblocks-shell-v0.0.43.zip
```
