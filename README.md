...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.50/solidblocks-shell-v0.0.50.zip > solidblocks-shell-v0.0.50.zip
unzip solidblocks-shell-v0.0.50.zip
```
