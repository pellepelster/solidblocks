...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.25/solidblocks-shell-v0.0.25.zip > solidblocks-shell-v0.0.25.zip
unzip solidblocks-shell-v0.0.25.zip
```
