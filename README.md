...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.35/solidblocks-shell-v0.0.35.zip > solidblocks-shell-v0.0.35.zip
unzip solidblocks-shell-v0.0.35.zip
```
