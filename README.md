...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.31/solidblocks-shell-v0.0.31.zip > solidblocks-shell-v0.0.31.zip
unzip solidblocks-shell-v0.0.31.zip
```
