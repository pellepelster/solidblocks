...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.42/solidblocks-shell-v0.0.42.zip > solidblocks-shell-v0.0.42.zip
unzip solidblocks-shell-v0.0.42.zip
```
