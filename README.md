...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.41/solidblocks-shell-v0.0.41.zip > solidblocks-shell-v0.0.41.zip
unzip solidblocks-shell-v0.0.41.zip
```
