...
#### Installation
```
curl -L https://github.com/pellepelster/solidblocks/releases/download/v0.0.48/solidblocks-shell-v0.0.48.zip > solidblocks-shell-v0.0.48.zip
unzip solidblocks-shell-v0.0.48.zip
```
