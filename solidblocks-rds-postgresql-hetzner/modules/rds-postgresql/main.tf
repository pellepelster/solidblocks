locals {
  ...
  user_data = templatefile("${path.module}/user_data.sh", {
    ...
    solidblocks_cloud_init_bootstrap = fileexists("${path.module}/blcks-cloud-init-bootstrap.sh") ? file("${path.module}/solidblocks-cloud-init-bootstrap.sh") : data.http.cloud_init_bootstrap_solidblocks.response_body
